...
theme_Job <- ggplot2::theme(
    ...
    axis.title.x = ggtext::element_textbox_simple(size = 12, width = NULL, halign = .5),
    axis.title.y = ggtext::element_textbox_simple(size = 12, orientation = 'left-rotated', width = NULL, halign = .5),
