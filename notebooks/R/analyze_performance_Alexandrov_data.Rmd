...
ggsave(plotnMMC.Alex, filename = "../figures/legend.svg")
```
...
ggsave(file = "../../katdetectr_manusscript/figures/plotAlexandrovRuntimes.jpeg", plotRunTimes.Alex, width = 7, height = 4)
```
