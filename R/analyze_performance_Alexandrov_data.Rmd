...
Calculate the performance of the kataegis detection tools regarding variant classfication
```{r}
...
```{r}
# facet labels
TMB.labs <- c("TMB >= 10", "0.1 >= TMB < 10", "0.1 < TMB")
...
ggsave(file = "../figures/plotAlexandrovDataPerformancePerVariantTMB.jpeg", plotPerformancePerVariantTMB, height = 5, width = 5.9)
```
...
ggsave(file = "../figures/plotAlexandrovRuntimesTotal.jpeg", plotRunTimesTotal, width = 12, height = 4)
...
```{r}
kdPD7409a <- katdetectr::detectKataegis(genomicVariants = alexandrovData$genomicVariants$PD7409a)
plotPD7409a <- katdetectr::rainfallPlot(kdPD7409a)
ggsave(file = "../figures/rainfall_PD74009a.png", plotPD7409a, height = 4, width = 6.5)

plotPD7409aZoom <- katdetectr::rainfallPlot(kd, showSequence = c("chr8", "chr13", "chrX"), showSegmentation = T)
ggsave(file = "../figures/rainfall_PD74009a_zoom.png", plotPD7409aZoom, height = 4, width = 6.5)
```
